...
public final class RatTerm {
  ...
  public double eval(double d) {
    ...
    return (this.coeff.doubleValue())*(pow(d, this.expt));
  }
  ...
  public RatTerm add(RatTerm arg) {
    // TODO: Fill in this method, then remove the RuntimeException
	  ...
	  // if there is one term with 0 expt
	  if (this.expt != 0) { 
		  return new RatTerm(this.coeff.add(arg.coeff),this.expt); 
	  }
  ...
  public RatTerm differentiate() {
    // TODO: Fill in this method, then remove the RuntimeException
	  ...
	  RatNum eTemp = new RatNum(this.expt);
	  RatNum c = this.coeff.mul(eTemp);
	  int e;
	  if (this.expt == 0) {
		  e = 0;
	  } else {
  ...
  public RatTerm antiDifferentiate() {
    // TODO: Fill in this method, then remove the RuntimeException
	  ...
	  RatNum eTemp = new RatNum(this.expt+1);
	  RatNum c = this.coeff.div(eTemp);
	  return new RatTerm(c,this.expt+1);
  }
